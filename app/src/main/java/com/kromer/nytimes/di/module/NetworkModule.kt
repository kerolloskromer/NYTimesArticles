...
import com.kromer.nytimes.BuildConfig
import com.kromer.nytimes.data.source.remote.ArticlesApiInterface
...
object NetworkModule {
    ...
    fun provideHeadersInterceptor(): Interceptor =
        Interceptor { chain: Interceptor.Chain ->
            ...
            httpBuilder.addQueryParameter("api-key", BuildConfig.API_KEY)
